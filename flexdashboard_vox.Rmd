...
X[, has_jetpack := ifelse(asset_trait_jetpack %like% "None", "No jetpack", "Jetpack")]
X[, has_jetpack := factor(has_jetpack, levels = c("Jetpack", "No jetpack"))]
...
gg <- ggplot(X, aes(asset_rank, price, color = has_jetpack, customdata = custom_data,
  ...
  scale_color_manual(values = c("No jetpack" = "steelblue3", "Jetpack" = "steelblue4")) +
